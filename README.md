...
Cascode Transistors – Increase the output resistance and improve the overall gain.
...
Requires larger voltage headroom due to stacked transistors
Biasing can be complex in low-voltage technologies
